...
#define FMT_SERIALIZE_CLASS_MEMBER_IMPL(r, class_name, i, ident)                                                       \
    BOOST_PP_COMMA_IF(i)::asmgrader::pair {                                                                            \
...
#define FMT_SERIALIZE_CLASS(class_name, ... /*members*/)                                                               \
    ...
    struct fmt::formatter<class_name>                                                                                  \
        : ::asmgrader::detail::AggregateFormatter<                                                                     \
              class_name,                                                                                              \
              #class_name __VA_OPT__(, BOOST_PP_SEQ_FOR_EACH_I(                                                        \
                                           FMT_SERIALIZE_CLASS_MEMBER_IMPL, class_name,                                \
                                           BOOST_PP_TUPLE_TO_SEQ(BOOST_PP_TUPLE_SIZE((__VA_ARGS__)), (__VA_ARGS__))))> \
    {                                                                                                                  \
    }
...
#define FMT_SERIALIZE_ENUM(enum_name, ... /*enumerators*/)                                                             \
    ...
    struct fmt::formatter<enum_name>                                                                                   \
        : ::asmgrader::detail::EnumFormatter<                                                                          \
              enum_name,                                                                                               \
              #enum_name __VA_OPT__(, BOOST_PP_SEQ_FOR_EACH_I(                                                         \

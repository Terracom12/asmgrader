...
//                     .str = take_remove_while(remaining_str, std::not_fn(is_strlike_end('\''), char_literal_start +
//                     1))};
//         }
//
...
//                         .str =
//                             take_remove_while(remaining_str, std::not_fn(is_strlike_end('"')), str_literal_start +
//                             1)};
//             }
//
//             // raw string literal
